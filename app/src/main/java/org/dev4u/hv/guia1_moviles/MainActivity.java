...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnAc,btnDel,btnIgual,btnPunto,btnOpenParentesis,btnCloseParentesis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Guia1_moviles_hm11i04001");
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            btnOpenParentesis = findViewById(R.id.btnParentesis1);
            btnCloseParentesis = findViewById(R.id.btnParentesis2);
